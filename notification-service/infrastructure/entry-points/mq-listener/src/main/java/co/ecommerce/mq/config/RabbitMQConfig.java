...
public class RabbitMQConfig {
    ...
    public MessageConverter messageConverter(){
        ...
        idClassMapping.put("co.ecommerce.model.inventoryevent.OrderPlacedEvent", OrderConfirmedEvent.class);

        // Si viene una cancelación, la mapeamos a nuestra clase local de cancelación
        idClassMapping.put("co.ecommerce.model.inventoryevent.OrderCancelledEvent", OrderCancelledEvent.class);
